...
### 1. Разработка ПО
Для создания клиентского приложения использовался язык Python, исходный код разделен на несколько модулей. Приложение использует различные библиотеки для работы с графикой, такие как Tkinter и Pillow. Ссылка на исходный код: [./Python/](./Python/).
...
Рис. 2. Анимация перемещения шарика
...
## Вывод
Закрепить навыки разработки программ с простым графическим интерфейсом пользователя на языке Python при помощи библиотеки Tkinter, получил представление о разработке простых игровых приложений.